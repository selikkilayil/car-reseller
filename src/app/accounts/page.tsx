        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{formatCurrency(cash?.balance || 0)}</p>
            </div>
          </div>
          {editingCash ? (
            <div className="flex gap-2">
              ...
              />
              <Button size="sm" onClick={updateCash}>Save</Button>
              <Button size="sm" variant="secondary" onClick={() => setEditingCash(false)}>Cancel</Button>
            </div>
          ) : (
            <Button size="sm" variant="ghost" onClick={() => { setEditingCash(true); setCashBalance(String(cash?.balance || 0)) }}>
              Update Balance
            </Button>
          )}
        </div>

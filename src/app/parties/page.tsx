  ...
  return (
    <div className="text-gray-900">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <Button variant={filter === 'SELLER' ? 'primary' : 'secondary'} size="sm" onClick={() => setFilter('SELLER')}>Sellers</Button>
        <Button variant={filter === 'BUYER' ? 'primary' : 'secondary'} size="sm" onClick={() => setFilter('BUYER')}>Buyers</Button>
        <Button variant={filter === 'BROKER' ? 'primary' : 'secondary'} size="sm" onClick={() => setFilter('BROKER')}>Brokers</Button>
        <Button variant={filter === 'DEALERSHIP' ? 'primary' : 'secondary'} size="sm" onClick={() => setFilter('DEALERSHIP')}>Dealerships</Button>
      </div>
